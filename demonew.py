...
class ActiveDirectoryDebugger:
    ...
    def setup_ui(self):
        ...
        self.search_base_label.grid(row=3, column=0, padx=5, pady=5, sticky="w")
        self.search_base_entry = ttk.Entry(self.frame)
        self.search_base_entry.grid(row=3, column=1, padx=5, pady=5, sticky="ew")

        self.function_var = tk.StringVar(value="user")
        self.function_label = ttk.Label(self.frame, text="Function:")
        self.function_label.grid(row=4, column=0, padx=5, pady=5, sticky="w")
        ...
        self.user_radio.grid(row=4, column=1, padx=5, pady=5, sticky="w")
        ...
        self.group_radio.grid(row=4, column=2, padx=5, pady=5, sticky="w")

        self.user_search_label = ttk.Label(self.frame, text="User 1 to Search:")
        self.user_search_label.grid(row=5, column=0, padx=5, pady=5, sticky="w")
        self.user_search_entry = ttk.Entry(self.frame)
        self.user_search_entry.grid(row=5, column=1, padx=5, pady=5, sticky="ew")

        self.add_user_btn = ttk.Button(self.frame, text="Add User 2", command=self.add_user)
        self.add_user_btn.grid(row=6, column=0, padx=5, pady=5)

        self.user2_search_label = ttk.Label(self.frame, text="User 2 to Search:")
        self.user2_search_label.grid(row=7, column=0, padx=5, pady=5, sticky="w")
        self.user2_search_entry = ttk.Entry(self.frame)
        self.user2_search_entry.grid(row=7, column=1, padx=5, pady=5, sticky="ew")
        ...
        self.search_btn.grid(row=8, column=0, padx=5, pady=5)

        self.compare_group1_label = ttk.Label(self.frame, text="Group 1:")
        self.compare_group1_label.grid(row=9, column=0, padx=5, pady=5, sticky="w")
        self.compare_group1_entry = ttk.Entry(self.frame)
        self.compare_group1_entry.grid(row=9, column=1, padx=5, pady=5, sticky="ew")

        self.compare_group2_label = ttk.Label(self.frame, text="Group 2:")
        self.compare_group2_label.grid(row=10, column=0, padx=5, pady=5, sticky="w")
        self.compare_group2_entry = ttk.Entry(self.frame)
        self.compare_group2_entry.grid(row=10, column=1, padx=5, pady=5, sticky="ew")

        self.compare_btn = ttk.Button(self.frame, text="Compare Groups", command=self.compare_groups)
        self.compare_btn.grid(row=11, column=0, padx=5, pady=5)
        ...
        self.user1_frame.grid(row=13, column=0, padx=5, pady=5, sticky="ew")
        ...
        self.user2_frame.grid(row=13, column=1, padx=5, pady=5, sticky="ew")
        ...
        self.export_user1_btn = ttk.Button(self.frame, text="Export User 1 Groups", command=self.export_user1_groups)
        self.export_user1_btn.grid(row=16, column=0, padx=5, pady=5)

        self.export_user2_btn = ttk.Button(self.frame, text="Export User 2 Groups", command=self.export_user2_groups)
        self.export_user2_btn.grid(row=16, column=1, padx=5, pady=5)

        self.export_missing_btn = ttk.Button(self.frame, text="Export Missing Groups", command=self.export_missing_groups)
        self.export_missing_btn.grid(row=17, column=0, columnspan=2, padx=5, pady=5)
    ...
    def search_user(self):
        ...
        conn.search(search_base, f'(sAMAccountName={user_to_search})', attributes=['memberOf'])
        user_groups = conn.entries[0].memberOf

        self.result_text.delete(1.0, tk.END)
        self.result_text.insert(tk.END, f"User {user_to_search} is a member of the following groups:\n")
        for group in user_groups:
            self.result_text.insert(tk.END, f"{group}\n")

        if self.user2_search_entry.winfo_ismapped():
            user2_to_search = self.user2_search_entry.get()
            conn.search(search_base, f'(sAMAccountName={user2_to_search})', attributes=['memberOf'])
            user2_groups = conn.entries[0].memberOf

            self.user1_text.delete(1.0, tk.END)
            self.user1_text.insert(tk.END, f"User {user_to_search} is a member of the following groups:\n")
            for group in user_groups:
                self.user1_text.insert(tk.END, f"{group}\n")

            self.user2_text.delete(1.0, tk.END)
            self.user2_text.insert(tk.END, f"User {user2_to_search} is a member of the following groups:\n")
            for group in user2_groups:
                self.user2_text.insert(tk.END, f"{group}\n")

            only_in_user1 = set(user_groups) - set(user2_groups)

...
def open_oauth_window(theme):
    ...
    def update_endpoint_entry(event):
        ...
        if selected_value:
            ...
            endpoint_entry.insert(0, selected_value)
        else:
            endpoint_entry.delete(0, tk.END)
    ...
    # Function to update well-known dropdown values
    ...
    ttk.Button(frame, text="Fetch Well-Known OAuth", command=fetch_well_known_oauth).grid(row=3, column=1, padx=5, pady=5)

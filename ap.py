...
NORD_STYLES = {
    "standard": {
    "background": "#1E4BC3",  #// Deep blue provides a strong, rich base.
    "foreground": "#E2E2E2",  #// Light gray for high contrast text on the blue background.
    "highlight": "#F9B612",   #// Warm golden yellow for emphasis and highlights.
    "error": "#FF0000",       #// Bright red is universally recognized for errors.
    "header": "#F9B612",      #// Consistent with highlight, draws attention to headers.
    "row_odd": "#304CB2",     #// Slightly darker blue for alternating rows.
    "row_even": "#1E4BC3",    #// Base blue for alternating rows.
    "button": "#F9B612",      #// Golden yellow for actionable elements like buttons.
    "invert_button": "#FF0000" #// Bright red for destructive or cancel actions.
...
def apply_theme(theme):
    ...
    colors = {
        ...
        "header": "#F9B612",      # Golden yellow
        "row_odd": "#304CB2",     # Slightly darker blue
        "row_even": "#1E4BC3",    # Base blue
        "button": "#F9B612",      # Golden yellow
        "invert_button": "#FF0000" # Bright red
    }
...
class NSLookup:
    ...
    def setup_ui(self):
        ...
        ttk.Label(self.frame, text="Refresh Time (s):").grid(row=1, column=4, padx=5, pady=5, sticky="e")
        self.refresh_time_entry = ttk.Entry(self.frame, width=10)
        self.refresh_time_entry.grid(row=1, column=5, padx=5, pady=5)
